...
class ConfirmationsControllerTest < ActionController::TestCase
  ...
  test "should create confirmation" do
    assert_difference('Confirmation.count') do
      post :create, confirmation: { confirmed: @confirmation.confirmed, court_id: @confirmation.court_id, infirmed: @confirmation.infirmed, user_id: @confirmation.user_id }
    end
  ...
  test "should update confirmation" do
    patch :update, id: @confirmation, confirmation: { confirmed: @confirmation.confirmed, court_id: @confirmation.court_id, infirmed: @confirmation.infirmed, user_id: @confirmation.user_id }
    assert_redirected_to confirmation_path(assigns(:confirmation))
  end

...
class CourtsControllerTest < ActionController::TestCase
  ...
  test "should create court" do
    assert_difference('Court.count') do
      post :create, court: { bar: @court.bar, date: @court.date, have_found: @court.have_found, jurisdiction: @court.jurisdiction, performance: @court.performance }
    end
  ...
  test "should update court" do
    patch :update, id: @court, court: { bar: @court.bar, date: @court.date, have_found: @court.have_found, jurisdiction: @court.jurisdiction, performance: @court.performance }
    assert_redirected_to court_path(assigns(:court))
  end
